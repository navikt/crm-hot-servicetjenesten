...
import getList from '@salesforce/apex/HOT_HomePageController.getList';
import getKnowledgeList from '@salesforce/apex/HOT_HomePageController.getKnowledgeList';
import getCaseList from '@salesforce/apex/HOT_HomePageController.getCaseList';
import getAnnouncementList from '@salesforce/apex/HOT_HomePageController.getAnnouncementList';
import getUserSkills from '@salesforce/apex/HOT_HomePageController.getUserSkills';
...
export default class hotHomePageList extends NavigationMixin(LightningElement) {
    @api cardLabel = 'Title';
    @api iconName = '';
    @api title = 'Name';
    @api content = '';
