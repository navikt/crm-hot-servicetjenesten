...
import updateNksStatus from '@salesforce/apex/HOT_HomePageController.updateNksStatus';

export default class hotHomePageHighlightPanelBadge extends LightningElement {
    @api badgeLabel;
